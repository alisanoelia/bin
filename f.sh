...
print_info() {
	printf "
	 ${bg_red}${text_black} os ${text_default}${bg_default} $(os)
${bg_default}(\ /)    ${bg_green}${text_black} kr ${text_default}${bg_default} $(shell)
${bg_default}( . .)   ${bg_yellow}${text_black} sh ${text_default}${bg_default} $(wm)
${bg_default}c(${bg_magenta}${text_black}\"${text_default}${bg_default})(${bg_magenta}${text_black}\"${text_default}${bg_default})  ${bg_cyan}${text_black} wm ${text_default}${bg_default} $(uptimesys)
\n"
}
